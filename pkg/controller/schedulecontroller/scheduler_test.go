...
func TestSchedule(t *testing.T) {
	...
	c, clientset := newScheduler(release, fixtures, chart.FetchRemote())
...
func TestChartNotReachable(t *testing.T) {
	...
	var chartUnreachableFunc chart.FetchFunc = func(chart shipperV1.Chart) (*helmchart.Chart, error) {
